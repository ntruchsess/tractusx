...
public class PartId {
  ...
  **/
  ...
  /**
  * Unique identifier of a single, unique physical (sub)component/part/batch, given by its manufacturer. For a vehicle, the Vehicle Identification Number (VIN).
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(oneIDManufacturer, objectIDManufacturer);
  }
