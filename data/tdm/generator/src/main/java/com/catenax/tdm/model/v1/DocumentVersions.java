...
@Entity
@Table(name = "aspect_documentation_version")
public class DocumentVersions extends ArrayList<DocumentVersionsInner> {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 8850504541694059190L;
