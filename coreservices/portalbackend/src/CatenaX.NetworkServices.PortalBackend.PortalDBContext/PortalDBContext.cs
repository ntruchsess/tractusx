...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseNpgsql("Server=devhost;Database=postgres;Port=5432;User Id=portal;Password=pwportal;Ssl Mode=Disable;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AgreementAssignedCompanyRole>(entity =>
            {
                ...
                entity.HasIndex(e => e.CompanyRoleId, "uk_6df9o1r7dy987w1pt9qnkopcv")
                    .IsUnique();
            ...
            modelBuilder.Entity<AgreementAssignedDocumentTemplate>(entity =>
            {
                ...
                entity.HasIndex(e => e.DocumentTemplateId, "uk_9ib7xuc1vke96s9rvlyhxbtuc")
                    .IsUnique();
            ...
            modelBuilder.Entity<AppLicense>(entity =>
            {
                ...
                entity.Property(e => e.AppLicenseId)
                    .ValueGeneratedNever()
            ...
            modelBuilder.Entity<CompanyRole>(entity =>
            {
                ...
                entity.Property(e => e.CompanyRole1)
                    .IsRequired()
                    .HasMaxLength(255)
            ...
            modelBuilder.Entity<CompanyUserRole>(entity =>
            {
                ...
                entity.Property(e => e.CompanyUserRoleId)
                    .ValueGeneratedNever()
                    .HasColumnName("company_user_role_id");

                entity.Property(e => e.CompanyUserRole1)
                    .IsRequired()
                    .HasMaxLength(255)
            ...
            modelBuilder.Entity<IdentityProvider>(entity =>
            {
                ...
                entity.Property(e => e.IdentityProviderCategoryId).HasColumnName("identity_provider_category_id");
            ...
            modelBuilder.Entity<Invitation>(entity =>
            {
                ...
                entity.Property(e => e.InvitationStatusId).HasColumnName("invitation_status_id");
