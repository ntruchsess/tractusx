...
variable "node_resource_group" {
  description = "(Optional) The resource group name of the cluster node(s)"
  type        = string
  default     = null
}
...
variable "log_analytics_workspace_id" {
  description = "(Optional) The ID of a Log Analytics Workspace"
  type        = string
  default     = null
}
...
variable "rbac_aad_admin_group_object_id" {
  description = "Object ID of group with admin access."
  type        = string
  default     = null
}
