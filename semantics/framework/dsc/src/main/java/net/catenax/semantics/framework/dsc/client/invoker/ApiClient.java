...
import feign.Logger;
import net.catenax.semantics.framework.dsc.client.invoker.auth.ApiKeyAuth;
import net.catenax.semantics.framework.dsc.client.invoker.auth.HttpBasicAuth;
import net.catenax.semantics.framework.dsc.client.invoker.auth.OAuth;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-09-08T16:15:16.333286600+02:00[Europe/Berlin]")public class ApiClient {
  ...
  private ObjectMapper createObjectMapper() {
    ...
    // Without this can not parse the data as
    // 2021-09-08T16:22:40.426+0200 , offset without colon
    SimpleModule simpleModule = new SimpleModule();
    DateTimeFormatter dateTimeFomrater = DateTimeFormatter.ofPattern("uuuu-MM-dd'T'HH:mm:ss.SSSX");
    simpleModule.addDeserializer(OffsetDateTime.class, new JsonDeserializer<OffsetDateTime>() {
      @Override
      public OffsetDateTime deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
        return OffsetDateTime.parse(jsonParser.readValueAs(String.class),dateTimeFomrater);
      }
    });
