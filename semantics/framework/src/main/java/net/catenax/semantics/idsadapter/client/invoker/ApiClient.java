package net.catenax.semantics.idsadapter.client.invoker;
...
import net.catenax.semantics.idsadapter.client.invoker.auth.*;
import net.catenax.semantics.idsadapter.client.invoker.auth.OAuth.AccessTokenListener;
