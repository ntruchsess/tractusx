...
import net.catenax.semantics.idsadapter.client.model.PagedModelRequestedResourceView;
import net.catenax.semantics.idsadapter.client.model.PagedModelSubscriptionView;
import net.catenax.semantics.idsadapter.client.model.RequestedResourceDesc;
import net.catenax.semantics.idsadapter.client.model.RequestedResourceView;
