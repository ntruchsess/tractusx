 ...
 */
public class TestTwinRegistryModel extends BaseSemanticModelTest {

   String TEST_NAMESPACE = "net.catena_x.semantics.twin";
    ...
    */
    ...
    public void testSemanticHubSuccess( final KnownVersion metaModelVersion ) {
       Model twinRegistryModel=loadModel( "", "TwinRegistry", metaModelVersion );
       checkValidity(twinRegistryModel, metaModelVersion );
    }
