...
import net.catenax.semantics.idsadapter.client.model.ApiEndpointsBody;
import net.catenax.semantics.idsadapter.client.model.EndpointsIdBody;
import net.catenax.semantics.idsadapter.client.model.PagedModelObject;
