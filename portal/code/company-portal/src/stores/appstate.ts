...
const M = {
  id: '0253dd4d-35af-43f5-a84c-7cc280840335',
  title: 'Catena-X Enabled Integrated Data Lake', rating: 5, downloads: 99, tags: ['FREE FOR USE','IDL'],
  ...
  usage: 'free for use',
  purchase: 'PURCHASE',
  companyName: 'Siemens', url: 'https://castidev-catenaxindustrialdat-castidev.eu1.mindsphere.io/'
}
