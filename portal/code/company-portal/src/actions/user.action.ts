...
export const addrolesComposite = createAction(UserActions.ADD_ROLES_COMPOSITE, (roleComposite: string[]) => roleComposite);
export const addFileNames = createAction(UserActions.ADD_FILE_NAMES, (fileNames: string[]) => fileNames);
