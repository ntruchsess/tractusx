import {mapBusinessPartnerToDataGrid,mapSingleBusinessPartnerToDataGrid} from 'utils/dataMapper'
...
import { BusinessPartner, BusinessPartnerResponse } from 'types/partnerNetwork/PartnerNetworkTypes'
...
describe('DataMapperTest', () => {
  ...
  it('mapBusinessPartnerToDataGrid maps correctly', () => {
    ...
    const mapDataGridResult = mockListToDataGridFunc(TestAPIData as unknown as BusinessPartnerResponse)
    ...
    expect(mapDataGridResult[randomEntry]).toStrictEqual(TestDataGridData[randomEntry])
  ...
  it('mapSingleBusinessPartnerToDataGrid maps correctly', () => {
    ...
    const mapDataGridResult = mockEntryToDataGridFunc(TestSingleData as unknown as BusinessPartner)
