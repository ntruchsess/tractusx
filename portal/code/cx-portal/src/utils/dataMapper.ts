...
const mapBusinessPartnerToDataGrid = (bpResponse: BusinessPartnerResponse): Array<PartnerNetworkDataGrid>=> {
...
const mapSingleBusinessPartnerToDataGrid = (bp: BusinessPartner): PartnerNetworkDataGrid=> {
