...
export const MultipleUserContent = () => {
  ...
  const dropzoneProps = {
    ...
    statusText: {
        ...
        rejected_max_files: t('content.addUser.userUpload.uploadStatus.rejected_max_files'),
        preparing: t('content.addUser.userUpload.uploadStatus.preparing'),
        error_file_size: t('content.addUser.userUpload.uploadStatus.error_file_size'),
        error_validation: t('content.addUser.userUpload.uploadStatus.error_validation'),
        ready: t('content.addUser.userUpload.uploadStatus.ready'),
        started: t('content.addUser.userUpload.uploadStatus.started'),
        getting_upload_params: t('content.addUser.userUpload.uploadStatus.getting_upload_params'),
        error_upload_params: t('content.addUser.userUpload.uploadStatus.error_upload_params'),
        uploading: t('content.addUser.userUpload.uploadStatus.uploading'),
        exception_upload: t('content.addUser.userUpload.uploadStatus.exception_upload'),
        ...
        headers_received: t('content.addUser.userUpload.uploadStatus.headers_received'),
