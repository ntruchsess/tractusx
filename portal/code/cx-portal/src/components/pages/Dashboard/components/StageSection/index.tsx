  ...
  return (
    <div className="stage-dashboard stage-section">
      <div className='stage-content'>
        ...
        <Button sx={{margin: '40px 0 0 10px' }} variant='outlined'>{t('content.dashboard.stage.cxButton')}</Button>
      </div>
      <div className="stage-background">
          <div className="image-wrapper image-ratio-parent">
            <img src="./home-stage-desktop.png" alt="Dashboard stage" className="object-fit x-left-40" />
          </div>
      </div>
    </div>
  )
