        ...
        return (
            <div className='w100pc h100pc df fdc'>
                <div className='ml50 mr50 mt50 bgfe w100-100 df fdc'>
                    ...
                    <span className='fs14 mt30'>Please finish the company onboarding by finishing the following task to activity participate and use all functions in the Catena-X Automotive Network Portal. Most of the task can be done parallel.</span>
                </div>
                <div className='ml50 mr50 mt30 bgfe w100-100 df fdc'>
                    <div className="collapse-list">
                        ...
                        <div className='mb10'>
                            ...
                            <label className="collapse-btn collapse-bg-white" htmlFor="collapse-2">
